      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">Project #{params.id}</h1>
                  ...
                  <div className="p-4 border-b border-border">
                    <div className="flex items-center justify-between">
                      <h3 className="font-semibold text-foreground">
                        {columnTitle}
                        <span className="ml-2 px-2 py-1 text-xs bg-border dark:bg-muted rounded-full">
                  ...
                  <div className="p-4 space-y-3 min-h-[400px]">
                    {[1, 2, 3].map((taskIndex) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between">
                          <span className="px-2 py-1 text-xs font-medium rounded-full bg-primary/15 text-primary dark:bg-primary/25 dark:text-primary">
                            Medium
                          </span>
