    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">
          Choose the active workspace for this session, then keep project-level permissions inside
          your own app.
        </p>
      </div>
            ...
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Switch the active Clerk organization that should scope your projects.
                </p>
              </div>
            </div>
            <CardInset as="div" className="p-4">
              <OrganizationList
                hidePersonal
          ...
          <CardContent className="p-6">
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  This is still Clerk-powered for free invites, but lives inside the same visual
                  language as the rest of your app.
                </p>
              </div>
            </div>
            <CardInset as="div" className="p-4">
