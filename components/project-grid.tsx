  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {projects.map((project) => (
        <div
          key={project.id}
          className="bg-background rounded-lg border border-border p-6 hover:shadow-lg transition-shadow cursor-pointer"
        >
          ...
          <div className="mb-4">
            ...
            <div className="w-full bg-border dark:bg-muted rounded-full h-2">
              <div
